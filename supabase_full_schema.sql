...
-- Insert common routines
INSERT INTO public.rotinas (tipo, descricao, trimestre, categoria)
VALUES 
('EXAME', 'UROCULTURA', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'UROCULTURA', 'TERCEIRO', 'OBRIGATORIO'),
('EXAME', 'GLICEMIA', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'GLICEMIA', 'SEGUNDO', 'OBRIGATORIO'),
('EXAME', 'TOXO IGM', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'TOXO IGG', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'HB / HT', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'HB / HT', 'TERCEIRO', 'OBRIGATORIO'),
('EXAME', 'HBsAG', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'HIV', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'HIV', 'TERCEIRO', 'OBRIGATORIO'),
('EXAME', 'TESTE RAPIDO HIV', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'TESTE RAPIDO HIV', 'TERCEIRO', 'OBRIGATORIO'),
('EXAME', 'VDRL', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'VDRL', 'TERCEIRO', 'OBRIGATORIO'),
('EXAME', 'TESTE RAPIDO SIFILIS', 'PRIMEIRO', 'OBRIGATORIO'),
('EXAME', 'URINA I', 'PRIMEIRO', 'OBRIGATORIO')

  ...
  useEffect(() => {
    if (isSupabaseConfigured) {
      Promise.all([
        ...
        supabase.from('consultas').select('id_consulta', { count: 'exact', head: true }),
        supabase.from('registro_rotinas').select('id_registro', { count: 'exact', head: true })
      ...
      const timer = setTimeout(() => {
        setStats({ operators: 3, categories: 12, professionals: 8, routines: 15, patients: 42, units: 5, gestations: 28, consultations: 156, examResults: 84 }); // Sample count
      }, 0);
      ...
      <div className="p-6 md:p-10 lg:p-16 pb-32 max-w-7xl mx-auto space-y-10 md:space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-10">
          <Link href="/operadores" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Operadores</span>
          ...
          <Link href="/pacientes" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Pacientes</span>
          ...
          <Link href="/categorias" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="w-16 h-16 rounded-3xl bg-primary/10 flex items-center justify-center mb-8 group-hover:bg-primary group-hover:-rotate-6 transition-all duration-500 shadow-lg shadow-primary/5">
              <Briefcase className="text-primary group-hover:text-white w-8 h-8 transition-colors" />
            </div>
            ...
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Categorias</span>
                <span className="text-3xl font-black text-primary font-headline">{stats.categories}</span>
              </div>
              <div className="w-12 h-12 rounded-2xl bg-surface-container-low flex items-center justify-center group-hover:bg-primary/10 transition-colors">
          ...
          <Link href="/profissionais" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Profissionais</span>
          ...
          <Link href="/rotinas" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            ...
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Rotinas</span>
          ...
          <Link href="/atendimentos" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            <div className="absolute top-0 right-0 w-48 h-48 bg-primary/5 rounded-full -mr-24 -mt-24 group-hover:scale-125 transition-transform duration-700" />
            
            <div className="w-16 h-16 rounded-3xl bg-primary/10 flex items-center justify-center mb-8 group-hover:bg-primary group-hover:rotate-6 transition-all duration-500 shadow-lg shadow-primary/5">
              <Stethoscope className="text-primary group-hover:text-white w-8 h-8 transition-colors" />
            </div>
            
            <h3 className="text-3xl font-black font-headline mb-3 text-on-surface tracking-tight">Atendimentos</h3>
            <p className="text-sm text-on-surface-variant/60 font-body mb-10 leading-relaxed">Registro de consultas, procedimentos clínicos e monitoramento de produtividade.</p>
            
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Atendimentos</span>
                <span className="text-3xl font-black text-primary font-headline">{stats.consultations}</span>
              </div>
              <div className="w-12 h-12 rounded-2xl bg-surface-container-low flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                <Plus className="w-6 h-6 text-on-surface-variant/40 group-hover:text-primary transition-colors" />
              </div>
          ...
          <Link href="/exames" className="bg-surface-container-lowest p-8 md:p-10 rounded-[2.5rem] md:rounded-[3rem] shadow-2xl shadow-black/5 border border-outline-variant/10 hover:border-primary/30 hover:shadow-primary/10 transition-all group relative overflow-hidden flex flex-col h-full">
            <div className="absolute top-0 right-0 w-48 h-48 bg-primary/5 rounded-full -mr-24 -mt-24 group-hover:scale-125 transition-transform duration-700" />
            
            <div className="w-16 h-16 rounded-3xl bg-primary/10 flex items-center justify-center mb-8 group-hover:bg-primary group-hover:rotate-6 transition-all duration-500 shadow-lg shadow-primary/5">
              <FlaskConical className="text-primary group-hover:text-white w-8 h-8 transition-colors" />
            </div>
            
            <h3 className="text-3xl font-black font-headline mb-3 text-on-surface tracking-tight leading-tight">Rotinas de Exames e Vacinas</h3>
            <p className="text-sm text-on-surface-variant/60 font-body mb-10 leading-relaxed">Lançamento de resultados de exames e aplicação de vacinas do calendário gestacional.</p>
            
            <div className="mt-auto flex items-center justify-between pt-8 border-t border-outline-variant/10">
              <div className="flex flex-col">
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-on-surface-variant/40 mb-1">Registros</span>
                <span className="text-3xl font-black text-primary font-headline">{stats.examResults}</span>
              </div>
              <div className="w-12 h-12 rounded-2xl bg-surface-container-low flex items-center justify-center group-hover:bg-primary/10 transition-colors">
                <Plus className="w-6 h-6 text-on-surface-variant/40 group-hover:text-primary transition-colors" />
              </div>
